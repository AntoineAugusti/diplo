...
public class AffichageCarte {
	...
	for (Case c : listeDeCases) {
	    ...
	    l1.append("\\e[" + couleur + "m" + limiteGauche + limiteHaute +
	    limiteHaute + limiteHaute + limiteHaute + limiteHaute +
	    limiteDroite + "\\e[0m");
	    if (c.id < 10) {
		l2.append("\\e[" + couleur + "m" + limiteGauche + "  " + " " +
		c.id + " " + limiteDroite + "\\e[0m");
	    } else {
		if ((c.id >= 10) && (c.id < 100))
		    l2.append("\\e[" + couleur + "m" + limiteGauche + " " +
		    " " + c.id + " " + limiteDroite + "\\e[0m");
	    ...
	    pionArmee(idArmee) + " " + limiteDroite + "\\e[0m");
	    l4.append("\\e[" + couleur + "m" + limiteGauche + limiteHBasse +
	    limiteHBasse + limiteHBasse + limiteHBasse + limiteHBasse +
	    limiteDroite + "\\e[0m");
	}
    }
