...
public class ComTests{
	...
	public static void main(String[] args) throws Throwable {
		...
		assert local.armees_restantes == 0 : "Les armees_restantes est non null";
		assert local.cases_controlees == 0 : "Le joueur n'a pas de cases";
		...
		assert !reponse.equals("En cours") : "L etat de la partie ne vaut pas En cours";
